...
df = pd.read_csv('E:\Public Repositories\Heart-Failure-Prediction\Model\heart.csv')
model = pickle.load(open('https://raw.githubusercontent.com/bumpansy/Heart-Failure-Prediction/blob/7bd6923a29a0b8939a168671e439b5f6523babf7/Model/model.pkl', 'rb'))
